...
## Corpus Check
- 154 files · ~312,545 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1475 nodes · 2786 edges · 96 communities (89 shown, 5 thin omitted)
...
### Community 0 - "Env"
Cohesion: 0.10
Nodes (36): Client, require_positive(), Address, token_client(), DataKey, equitable_price_floor(), FractachainLicitacionContract, LegalInfo (+28 more)
...
### Community 6 - "kyc.rs"
Cohesion: 0.17
Nodes (26): get_investor_info(), has_voting_rights(), InvestorInfo, InvestorType, is_argentina_business_hours(), is_gafi_blacklisted(), is_investor_verified(), kyc_hours_enforced() (+18 more)

### Community 7 - "test_runner.ts"
Cohesion: 0.07
Nodes (29): authenticateWithGoogle(), AuthUser, DEMO_USER, getUserByToken(), revokeSession(), sessions, usersByEmail, ArisOnRampResponse (+21 more)

### Community 8 - "Development Patterns"
Cohesion: 0.11
Nodes (19): Auth trees and cross-contract propagation, Authorization, Constructors, Contract size, Cross-contract calls, Custom accounts (`__check_auth`), Data types, DeFi patterns (+11 more)
...
Cohesion: 0.10
Nodes (23): bindContract(), createProduct(), DEFAULT_TESTNET_ASSETS, getPaymentAssets(), IssuanceProduct, listProducts(), ProductKind, products (+15 more)
...
Cohesion: 0.14
Nodes (14): Frequently used contract capabilities, High-value CAPs for smart contract developers, I am building a fungible token, I am building a smart-wallet flow, I need anchor integration for fiat rails, I need upgrade-safe contracts, Maintenance note, Newer and draft crypto/features (+6 more)
...
### Community 18 - "api.ts"
Cohesion: 0.14
Nodes (13): AdminKycPage(), AdminTestnetPage(), PoolDetailPage(), DEFAULT_STOCKS, API_BASE_URL, getApiBaseUrl(), IssuanceProduct, KycRecord (+5 more)

### Community 19 - "orderbook/page.tsx"
Cohesion: 0.20
Nodes (10): Book, fmtQty(), fromSdex(), Level, Market, MyOrder, OrderbookInner(), SdexLevel (+2 more)

### Community 21 - "Storage"
Cohesion: 0.50
Nodes (4): Choosing storage — decision tree, Storage, TTL management, Typed storage keys
...
Cohesion: 0.12
Nodes (13): ForwardContract, MOCK_FORWARDS, ContractData, ContractInspectorBanner(), CONTRACTS, DynamicHeroText(), SECTORS, IssuerCtaBanner() (+5 more)
...
Cohesion: 0.14
Nodes (15): AdminIssuancePage(), empty, DashboardPage(), LoginInner(), KycOnboardingPage(), PendingKycPage(), WalletOnboardingPage(), MOCK_MNEMONIC (+7 more)
...
Cohesion: 0.18
Nodes (10): metadata, HomePage(), BrandMark(), CrystalBackdrop(), Footer(), adminLinks, Navbar(), primaryLinks (+2 more)
...
### Community 44 - "standards/SKILL.md"
Cohesion: 0.38
...
### Community 49 - "PartnersShowcase.tsx"
Cohesion: 0.20
Nodes (8): BrandLogo(), MervalLogosSection(), Partner, PARTNERS, PartnersShowcase(), INSTITUTION_SLOTS, partnerSlug(), MERVAL_NAMES
...
### Community 54 - "listings.ts"
Cohesion: 0.06
Nodes (81): PaymentKind, applyDueClose(), applySettleChoice(), closeListing(), CompanyDossier, contractId(), createListing(), DATA (+73 more)
...
Cohesion: 0.09
Nodes (36): Account, accounts, ADMIN_EMAILS, CustodyMode, DATA_DIR, ensureAdminAccount(), getAccountByToken(), hashPassword() (+28 more)
...
Cohesion: 0.12
Nodes (32): contributeListing(), getListing(), tradeableMarkets(), addHolding(), addTrustline(), cashBalance(), claimListingTokens(), creditCash() (+24 more)
...
### Community 95 - "High-value SEPs for app developers"
Cohesion: 0.50
Nodes (4): Anchor and fiat integration, Auth, identity, and metadata, Contracts and token interfaces, High-value SEPs for app developers

## Knowledge Gaps
- **622 isolated node(s):** `name`, `version`, `description`, `main`, `build` (+617 more)
...
- **Should `Env` be split into smaller, more focused modules?**
  _Cohesion score 0.09550989345509893 - nodes in this community are weakly interconnected._
